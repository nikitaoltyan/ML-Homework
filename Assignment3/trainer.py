    ...
    def fit(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch_indices in batches_indices:
                ...
                bX = self.dataset.train_X[batch_indices]
                bY = self.dataset.train_y[batch_indices]
                loss = self.model.compute_loss_and_gradients(bX, bY)
            ...
            alpha0 = 0.2 # as Andrew Ng suggested
